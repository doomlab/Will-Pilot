...
TO DO ADD THE MTMM STUDY FINALLY 
...
TO DO ADD MORE TEXT AND TALK ABOUT THIS STUFF 

RESPONSE: [Erin]
- look at original thesis for justification for valence
...
- add information from will's thesis back in there
...
RESPONSE: [Erin]
- move readability stats to an appendix
...
We added an example table of the weighting calculation and rephrased this section completely.
...
Unfortunately, as with many linguistic analyses that focus on individual words (as with the MFD), context is lost using these approaches. In response to the question about analytic choices, we have added information about a MTMM study, as well as the exact same statistics using the raw percentages. 
...
TO DO COMMENT HERE ABOUT THE ORIGINAL SCORING BEING SHIT AS WELL 
