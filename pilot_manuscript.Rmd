...
Using the *nlme* library in *R*, a 2 (Political Lean) by 5 (MFD area) multillevel model with news source as a random intercept was analyzed to control for correlated error between articles published in the same news source. An intercept-only model was compared to a random intercept model with the news sources as the random factor, and ...SAY HERE WHAT HAPPENED? PROB A TABLE OF THE MODEL #S. 
