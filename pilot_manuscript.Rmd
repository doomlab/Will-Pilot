...
#put in the numbers
tableprint[1, ] = c("Harm", harm_d$M1, harm_d$sd1, harm_d$M2, harm_d$sd1, 
...
- list that here: here's when the stuff was happening and so picked two weeks before and after 
