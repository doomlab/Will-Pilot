...
```
# Discussion 
What we found - nothing really, even some disconfirming evidence, but it wasn't sig and eff size was small.

Why it might not have worked (focus too broad??)

Well, this was exploratory anyway, so lets firm up the method and try another way. How about a polarizing and morally-focused singular issue?? Which leads us to Experiment 2, in which we hope to confirm the method!! 
