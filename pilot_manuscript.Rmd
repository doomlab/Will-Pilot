...
harm_final_data$percent = harm_final_data$Freq / harm_final_data$wordcount *100
harm_final_data$lean = factor(harm_final_data$Source, 
                              levels = names(table(harm_final_data$Source)),
                              labels = c("Conservative1", "Conservative",
                                  "Liberal1", "Liberal"))
harm_final_data$lean = gsub("1", "", harm_final_data$lean)

harm_final_data$weighted = harm_final_data$percent*harm_final_data$valence
