...
- list those here:
  ...
  ABC News
  USA TODAY
  Drudge Report *HEY! THIS IS MOSTLY AN AGGREGATOR!!! IS IT STILL OK? The answer is NOPE*
  MSNBC *CLOSEST TO POLITICAL CENTER; buh-bye!*
...
As in Experiment 1, the text was scanned using the *ngram* package in *R* at the conclusion of data collection [@Schmidt2017]. Using the package's word count function, articles that came through as blank text were removed, as well as text scraped from the Disqus commenting system. Duplicate articles were subsequently discarded.
