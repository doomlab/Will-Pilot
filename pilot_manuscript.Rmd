...
Table 4 displays descriptive statistics for articles about the partial government shutdown. 

```{r exp2_source_descriptives_kav, results = 'asis', echo = FALSE, message = F}
#Kav
...
tableprint[ , 1] = print(unique(final_kav$Source))
...
tableprint[ , 4] = tapply(final_kav$X, final_kav$Source, length)
...
```{r exp2_source_descriptives_gs, results = 'asis', echo = FALSE, message = F}
#Kav
#GS
