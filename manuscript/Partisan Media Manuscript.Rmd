...
Ever increasing attention is being paid to the impacts of partisanship on how people give and receive political information. The style and content of political information can be quantified in many ways, and one of those ways is motivation. 

In the current study, we explore the motivations of partisan media coverage through the lens of McClelland's classic theory of motivation. 
...
table1 = matrix(NA, ncol = 12, nrow = 10)
...
table2 = matrix(NA, ncol = 12, nrow = 10)
...
table3 = matrix(NA, ncol = 12, nrow = 10)
...
# Create IVs and DVs
groups = c(0, 1)
DVs = c('i','you','shehe','we','they','ipron','affiliation','achieve','power')
